                ...
                <div className="w-screen mt-[18px] bg-transparent ">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center">
                            ...
                            <div className={`ml-[70px] space-x-[40px] font-medium text-[16px] leading-[16px] tracking-[-0.05em] ${isListPage || isFaqPage || isAboutPage ? 'text-black' : 'text-white'} `}>
                                <Link href="/">Home</Link>
                        ...
                        <div className="flex items-center  mr-[135px] ">
                            <button type="button" className="flex items-center  bg-[#30B887] rounded rounded-[8px] px-5 py-2.5 mr-[10px]">
