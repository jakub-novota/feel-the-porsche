...
export default function FAQ() {
    return (
        <>
            <div className="flex">
                <div className="w-[40%]  flex justify-center 2xl:justify-end ">
                    <div className=" ">
                        ...
                        <p className="mt-[8px] text-[16px] leading-[22px] tracking-[-0.05em] text-[#313131] max-w-[338px]">Take a look at the answers to the most frequent questions.Is there still something unclear? Contact us.</p>
                    </div>
                </div>
