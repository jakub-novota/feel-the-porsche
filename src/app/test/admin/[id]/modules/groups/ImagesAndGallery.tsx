                ...
                <div className="mb-4">
                    ...
                    <div className="flex flex-wrap">
                        {Object.entries(car.image_cars).map(([key, image]) => (
                            ...
                            >
                                <img src={image} alt={`Cover Image ${key}`} className="w-full h-full object-cover rounded" />
                            </div>
                        ))}
                    </div>
                </div>
                    ...
                    <div className="flex flex-wrap">
                        {Object.entries(car.gallery).map(([key, image]) => (
                            <div
                                ...
                                onClick={() => handleImageClick(image)}
                            >
                                <img src={image} alt={`Gallery Image ${key}`} className="w-full h-full object-cover rounded" />
                            </div>
                        ))}
                    </div>
                </div>
