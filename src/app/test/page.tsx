...
export default function () {
    ...
    return (
        <div className='flex justify-center h-screen items-center flex-col'>
            <div className='flex flex-col  w-[268px] py-[31px] px-[30px] rounded-[24px]  bg-[#ffffffcc]   border-red shadow-[0px_20px_60px_rgba(74,80,83,0.3)] sm:rounded-[90px] sm:w-[975px] sm:h-[101px] sm:items-center sm:justify-center '>
